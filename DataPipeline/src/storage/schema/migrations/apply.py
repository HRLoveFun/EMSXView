...
Usage (CLI):
    ...
    python -m DataPipeline.src.storage.schema.migrations.apply --db path/to/regime.db
    python -m DataPipeline.src.storage.schema.migrations.apply --dry-run
...
5. Final user_version MUST equal SCHEMA_VERSION; mismatch raises.
"""
