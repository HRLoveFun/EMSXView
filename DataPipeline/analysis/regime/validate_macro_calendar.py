...
Usage:
    python -m DataPipeline.analysis.regime.validate_macro_calendar
    python -m DataPipeline.analysis.regime.validate_macro_calendar --csv path/to/file.csv
"""
...
_THIS = Path(__file__).resolve()                              # DataPipeline/analysis/regime/validate_macro_calendar.py
_PROJECT_ROOT = _THIS.parents[3]                              # EMSX/
DEFAULT_CSV_PATH = _PROJECT_ROOT / "CostView" / "data" / "macro_calendar.csv"
