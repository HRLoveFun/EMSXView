...
Idempotent (UPSERT). Run after editing market_mapping.json:
    python -m DataPipeline.analysis.regime.sync_market_mapping
"""
...
_THIS = Path(__file__).resolve()                              # DataPipeline/analysis/regime/sync_market_mapping.py
_PROJECT_ROOT = _THIS.parents[3]                              # EMSX/
DEFAULT_JSON_PATH = _PROJECT_ROOT / "CostView" / "data" / "market_mapping.json"
