...
Idempotent (UPSERT). Run after editing the json:
    python -m DataPipeline.analysis.regime.sync_macro_event_dict
"""
...
_THIS = Path(__file__).resolve()                              # DataPipeline/analysis/regime/sync_macro_event_dict.py
_PROJECT_ROOT = _THIS.parents[3]                              # EMSX/
DEFAULT_JSON_PATH = _PROJECT_ROOT / "CostView" / "data" / "macro_event_dict.json"
