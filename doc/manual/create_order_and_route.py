# create_order_and_route.py
# Bloomberg EMSX API - CreateOrderAndRouteEx Request
# Source: EMSX-API-Complete-Guide.md - "CreateOrderAndRouteEx" section
# Quick Reference: Section 4.1/4.2
    ...
    def processServiceStatusEvent(self,event,session):
        ...
        for msg in event:
            if msg.messageType() == SERVICE_OPENED:
                ...
                #request.set("EMSX_ROUTE_REF_ID", "UniqueRouteRef")
                #request.set("EMSX_STOP_PRICE", 123.5)
                #request.set("EMSX_TRADER_UUID", 1234567)

                # Optional: Set broker strategy parameters
                ...
                #data.appendElement().setElement("EMSX_FIELD_DATA", "10:30:00")
                #indicator.appendElement().setElement("EMSX_FIELD_INDICATOR", 0)
