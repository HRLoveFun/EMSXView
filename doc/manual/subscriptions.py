# subscriptions.py
# Bloomberg EMSX API - Order and Route Subscriptions
# Source: EMSX-API-Complete-Guide.md - "Subscriptions" section
# Quick Reference: Section 3 Subscriptions
#
# This example subscribes to both order and route blotters and processes
# SUBSCRIPTION_DATA events (not RESPONSE). Uses EVENT_STATUS to distinguish:
#   1  = Heartbeat
#   4  = Initial paint
#   6  = New order/route
#   7  = Update
#   8  = Deletion
#   11 = End of initial paint
