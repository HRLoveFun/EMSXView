# assign_trader.py
# Bloomberg EMSX API - AssignTrader Request
# Source: EMSX-API-Complete-Guide.md - "AssignTrader" section
# Quick Reference: Section 4.5 Administrative
    ...
    def processServiceStatusEvent(self,event,session):
        ...
        for msg in event:
            ...
            if msg.messageType() == SERVICE_OPENED:
                ...
                # Mandatory fields
                request.append("EMSX_SEQUENCE", 1234567)  # Order number
                request.set("EMSX_ASSIGNEE_TRADER_UUID", 7654321)  # Target trader UUID
