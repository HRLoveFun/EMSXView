# get_broker_strategy_info.py
# Bloomberg EMSX API - GetBrokerStrategyInfoWithAssetClass Request
# Source: EMSX-API-Complete-Guide.md - "GetBrokerStrategyInfoWithAssetClass" section
# Quick Reference: Section 4.4 Broker Info
