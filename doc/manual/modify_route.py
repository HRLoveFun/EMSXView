# modify_route.py
# Bloomberg EMSX API - ModifyRouteEx Request
# Source: EMSX-API-Complete-Guide.md - "ModifyRouteEx" section
# Quick Reference: Section 4.2 Route Management
#
# NOTE: EMSX_LIMIT_PRICE=0 means ignore, EMSX_LIMIT_PRICE=-99999 means reset to 0
# NOTE: EMSX_STOP_PRICE=-1 clears the stop price
    ...
    def processServiceStatusEvent(self,event,session):
        ...
        for msg in event:
            if msg.messageType() == SERVICE_OPENED:
                ...
                # If modifying on behalf of another trader
                #request.set("EMSX_TRADER_UUID", 1234567)

                # If modifying a multi-leg route
