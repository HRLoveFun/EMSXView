# get_trade_desks.py
# Bloomberg EMSX API - GetTradeDesks Request (AIM Only)
# Source: EMSX-API-Complete-Guide.md - "GetTradeDesks" section
# Quick Reference: Section 4.5 Administrative Requests
#
# NOTE: This is an AIM only function. Uses PRODUCTION endpoint //blp/emapisvc
