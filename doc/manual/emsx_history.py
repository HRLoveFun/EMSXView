# emsx_history.py
# Bloomberg EMSX API - EMSXHistory (GetFills) Request
# Source: EMSX-API-Complete-Guide.md - "EMSXHistory" section
# Quick Reference: Section 4.6 History Service
#
# NOTE: Uses //blp/emsx.history.uat service. Max range: 30 days.
# Handles both RESPONSE and PARTIAL_RESPONSE events.
