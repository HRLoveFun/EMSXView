...
Usage:
    python scripts/ops/import_excel_fills.py --dry-run    # Analysis only
    python scripts/ops/import_excel_fills.py --execute    # Execute import
"""
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python scripts/ops/import_excel_fills.py --dry-run                       # Analyze mapping
  python scripts/ops/import_excel_fills.py --execute                       # Run import (all files)
  python scripts/ops/import_excel_fills.py --execute --file fills_20260302_20260306.xlsx
        """,
    )
