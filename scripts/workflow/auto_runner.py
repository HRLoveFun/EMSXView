...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    p.add_argument("--status-file", default="plans/execution-platform-status.yaml")
    p.add_argument("--risk-file", default="plans/execution-platform-risk-register.yaml")
    p.add_argument("--policy-file", default="plans/execution-platform-autopilot-policy.yaml")
    p.add_argument("--runstate-file", default="plans/execution-platform-autopilot-runstate.json")
