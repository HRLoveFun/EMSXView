...
- 功能 → 目录映射：
  ...
  | 前端模块代码 | 一律仓库根级：`ExecutionView/module/`、`CostView/module/`、`MarketView/module/`（与 `frontend/` 平级，各带 `standalone/` 独立构建入口）；`frontend/src/` 只放壳层与共享层（见 [docs/archive/2026-09-21/018-costview-marketview-root-extract/plan.md](docs/archive/2026-09-21/018-costview-marketview-root-extract/plan.md)） |
