...
| [docs/PROJECT_STRUCTURE.md](./docs/PROJECT_STRUCTURE.md) | Canonical architecture reference |
| [docs/DATA_DOMAIN.md](./docs/DATA_DOMAIN.md) | Logical data domain design |
| [docs/SERVICE_MANAGEMENT.md](./docs/SERVICE_MANAGEMENT.md) | Service operations and troubleshooting |
