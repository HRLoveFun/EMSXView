...
---
Decompose the following task into a structured implementation plan:

1. Parse the requirements and identify constraints
2. List all affected files and modules
3. Break into ordered sub-tasks with clear dependencies
